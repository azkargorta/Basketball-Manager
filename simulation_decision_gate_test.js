...
if(!version.includes("label:'v0.46 Beta'")||!html.includes('js/app.js?v=v046')||!sw.includes('basketball-gm-beta-v046'))throw new Error('Versión o caché incorrectas');
...
console.log(JSON.stringify({simulationBlocked:true,automaticNotice:true,resolvedAllowsContinue:true,version:'v0.46',ok:true},null,2));
