...
if(!version.includes("label:'v0.44 Beta'")||!html.includes('js/app.js?v=v044')||!sw.includes('basketball-gm-beta-v044'))throw new Error('Versión o caché incorrectas');
...
console.log(JSON.stringify({simulationBlocked:true,automaticNotice:true,resolvedAllowsContinue:true,version:'v0.44',ok:true},null,2));
