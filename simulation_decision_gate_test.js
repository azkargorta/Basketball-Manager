...
if(!version.includes("label:'v0.45 Beta'")||!html.includes('js/app.js?v=v045')||!sw.includes('basketball-gm-beta-v045'))throw new Error('Versión o caché incorrectas');
...
console.log(JSON.stringify({simulationBlocked:true,automaticNotice:true,resolvedAllowsContinue:true,version:'v0.45',ok:true},null,2));
