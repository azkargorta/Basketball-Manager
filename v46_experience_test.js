...
const checks=[
  ['tutorial',app.includes('maybeShowV46Tutorial')&&app.includes('finishV46Tutorial')],
  ...
  ['version/cache',version.includes("label:'v0.46 Beta'")&&version.includes('basketball-gm-beta-v046')]
];
